...
volatile uint16_t ADC1_LastValue = 0U;
volatile uint16_t ADC1_DMA_Buffer[ADC1_DMA_BUFFER_LENGTH];
/* USER CODE END PV */
...
int main(void)
{
  ...
  { Error_Handler(); }
  if (HAL_DAC_SetValue(&hdac1, DAC_CHANNEL_1, DAC_ALIGN_12B_R, MOTOR_COMP_THRESHOLD_DAC) != HAL_OK)
  { Error_Handler(); }
...
static void MX_TIM1_Init(void)
{
  ...
  sConfigOC.OCMode = TIM_OCMODE_PWM1;
  sConfigOC.Pulse = MOTOR_COMP_BLANKING_TICKS;
  ...
  sClearInputConfig.ClearInputSource = TIM_CLEARINPUTSOURCE_COMP3;
  ...
  sClearInputConfig.ClearInputFilter = 2;
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(OUTEST_GPIO_Port, OUTEST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : OUTEST_Pin */
  GPIO_InitStruct.Pin = OUTEST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(OUTEST_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : STOP_Pin OTV_Pin INKREM_Pin */
  GPIO_InitStruct.Pin = STOP_Pin|OTV_Pin|INKREM_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : KON_Z_Pin KON_O_Pin ZAV_Pin */
  GPIO_InitStruct.Pin = KON_Z_Pin|KON_O_Pin|ZAV_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
